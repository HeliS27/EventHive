    ...
    <div class="auth-page">
      <div class="auth-card">
        <div class="auth-header">
          <div class="auth-logo">
            <span nz-icon nzType="user-add" nzTheme="outline" style="font-size: 28px; color: #1d4ed8;"></span>
          </div>
          <h1>Create Account</h1>
          <p>Join EventHive and explore tech events</p>
        </div>
        
        <form nz-form [formGroup]="registerForm" nzLayout="vertical" (ngSubmit)="submitForm()">
          <nz-form-item>
            <nz-form-label nzRequired>Full Name</nz-form-label>
            <nz-form-control nzErrorTip="Please input your full name!">
              <nz-input-group [nzPrefix]="userIcon" style="border-radius: 8px;">
                <input type="text" nz-input formControlName="fullName" placeholder="John Doe" style="border-radius: 8px; padding: 8px 12px;" />
              </nz-input-group>
              <ng-template #userIcon><span nz-icon nzType="user" style="color: #98a2b3;"></span></ng-template>
            </nz-form-control>
          </nz-form-item>
          ...
          <button nz-button nzType="primary" [nzLoading]="isLoading" nzBlock class="submit-btn">Create Account</button>
